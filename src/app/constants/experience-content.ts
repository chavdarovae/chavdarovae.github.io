...
export const EXPERIENCE_CONTENT: IWorkExperience[] = [
	{
		...
		description: `<p>
					Development and UX design of three Angular applications, that cover the whole freight furthering workflow. Organised in a
				</p>
				<ul class="text-like-list">
					<li><a href="https://new.colleta.de/">Colleta für Disponenten</a> - Transport dispatcher
						platform, where shipments are disopsed and tours are assigned</li>
					<li><a href="https://tu.colleta.de/">Colleta für Transporunternehmer</a> - Transport service provider
						platform, where transoprt orders are received</li>
					<li><a href="https://backoffice.colleta.de/">Colleta für Betreiber</a> - User management platform, binding
